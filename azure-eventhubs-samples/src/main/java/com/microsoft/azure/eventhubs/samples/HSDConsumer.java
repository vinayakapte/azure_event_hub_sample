...
public class HSDConsumer {
	...
	private static EventHubClient receiveMessages(ConnectionStringBuilder connStr, final String partitionId)
	{
	...
	public static void main( String[] args ) throws IOException{
		...
		EventHubClient client0 = receiveMessages(connStr, "0");
		EventHubClient client1 = receiveMessages(connStr, "1");
		EventHubClient client2 = receiveMessages(connStr, "2");
		EventHubClient client3 = receiveMessages(connStr, "3");
